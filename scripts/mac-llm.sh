...
MODEL_PATH="${EZ_MAC_LLM_MODEL_PATH:-$APP_DIR/models/llm/gemma-4-e4b-hauhaucs-aggressive-q4-vision/Gemma-4-E4B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf}"
MMPROJ_PATH="${EZ_MAC_LLM_MMPROJ_PATH:-$APP_DIR/models/llm/gemma-4-e4b-hauhaucs-aggressive-q4-vision/mmproj-Gemma-4-E4B-Uncensored-HauhauCS-Aggressive-f16.gguf}"
MODEL_ALIAS="${EZ_MAC_LLM_MODEL_ALIAS:-mac-gemma-4-e4b-hauhaucs-aggressive-q4-vision}"
