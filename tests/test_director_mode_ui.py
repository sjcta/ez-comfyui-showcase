...
class DirectorModeUiTests(unittest.TestCase):
    def test_quick_form_has_director_panel_and_submission_sync(self):
        ...
        self.assertIn("function _directorPlacementValue()", generate_js)
        self.assertIn("function _setDirectorPlacementMode(mode)", generate_js)
        ...
        self.assertIn("data-director-placement=\"middle\"", generate_js)
        self.assertIn("data-director-placement=\"end\"", generate_js)
        self.assertIn("作为尾帧", generate_js)
        self.assertIn("后段生成", generate_js)
    ...
    def test_director_panel_has_floating_layout_styles(self):
        ...
        self.assertIn(".director-placement", css)
        self.assertIn(".director-placement button.active", css)
